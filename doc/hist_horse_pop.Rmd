...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1 : Historical number of horses per province in Canada"}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2 : Historical number of horses per province in Canada" }
